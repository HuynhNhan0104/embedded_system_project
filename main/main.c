...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_DATA:
        ...
        if(strcmp(method,"buzzer")==0){
            ...
            gpio_set_level(GPIO_NUM_13,value);
        }
        else if(strcmp(method,"pump")==0){
            int len = sprintf(command, "!DP%d##\r\n",value);
            printf("%s",command);
            // gpio_set_level(GPIO_NUM_12,x);
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        ...
        // .credentials.username = "GnwwzmkVeRMDT2a9u8qO",
        // .credentials.username = "nQuwxOKE8v7nFioIdbO5",
...
void app_main(void)
{
    ...
    ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0, 700);
